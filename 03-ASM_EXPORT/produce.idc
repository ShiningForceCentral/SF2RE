...
static produceSpecificSectionFour(mainFile,sectionName,start,end,fs,sectionComment){
    ...
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\battlesceneengine_2",0x19DFE,0x19E5E,"Battlescene engine");
    produceAsmScript(file,"data\\battles\\global\\terrainbackgrounds",0x19E5E,0x19E6E,"Terrain backgrounds table");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\battlesceneengine_3",0x19E6E,0x1F806,"Battlescene engine");
