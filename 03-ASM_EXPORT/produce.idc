...
static produceSpecificSectionOne(mainFile,sectionName,start,end,fs,sectionComment){
    ...
    produceAsmScript(file,"code\\gameflow\\start\\systeminit",0x200,0x2DE,"System initialization functions");
    produceAsmScript(file,"code\\gameflow\\start\\gamestart",0x2DE,0x3F6,"Start function");
    produceAsmScript(file,"code\\gameflow\\start\\z80init",0x3F6,0x45C,"Z80 initialization function");
    produceAsmScript(file,"code\\common\\tech\\interrupts\\trap0_soundcommand",0x45C,0x490,"Trap 0 - Sound Command");
    ...
    produceAsmScript(file,"code\\common\\tech\\interrupts\\vint",0x594,0x7CE,"Vertical Interrupt - Triggered at each frame display");
    produceAsmScript(file,"code\\common\\tech\\interrupts\\trap9_contextualfunctions",0x7CE,0x8DE,"Trap 9 - Contextual Functions Management");
    produceAsmScript(file,"code\\common\\tech\\interrupts\\applyfadingeffectandz80busupdate",0x8DE,0xB1E,"Vertical Interrupt Engine");
    produceAsmScript(file,"data\\tech\\fadingdata",0xB1E,0xB96,"Fading data table");
    produceAsmScript(file,"code\\common\\tech\\interrupts\\vdpcontrol",0xB96,0xCC4,"Vertical Interrupt Engine - VDP control functions");
    produceAsmScript(file,"code\\common\\tech\\interrupts\\unused_palettecopy",0xCC4,0xCD6,"Unused palette copy function");
    produceAsmScript(file,"code\\common\\tech\\interrupts\\fadingcommands",0xCD6,0xDBA,"Commands used in scripts to fade screen in or out of white or black");
    produceAsmScript(file,"code\\common\\tech\\interrupts\\vintengine_1",0xDBA,0xF1A,"Vertical Interrupt Engine - Main Technical Engine - Triggered at each frame display, part 1");
    produceAsmScript(file,"code\\common\\tech\\interrupts\\unused_vint_1",0xF1A,0xF2A,"Unused Vertical Interrupt engine functions");
    produceAsmScript(file,"code\\common\\tech\\interrupts\\enabledmaqueueprocessing",0xF2A,0xF3A,"Vertical Interrupt Engine - DMA Request bit setter function");
    produceAsmScript(file,"code\\common\\tech\\interrupts\\unused_vint_2",0xF3A,0x10DC,"Unused Vertical Interrupt engine functions");
    produceAsmScript(file,"code\\common\\tech\\interrupts\\vintengine_2",0x10DC,0x1234,"Vertical Interrupt Engine - Main Technical Engine - Triggered at each frame display, part 2");
    produceAsmScript(file,"code\\common\\tech\\interrupts\\updatescrolldata",0x1234,0x1382,"Horizontal and Vertical Scroll data update functions");
    produceAsmScript(file,"code\\common\\tech\\interrupts\\vintengine_3",0x1382,0x13C0,"Vertical Interrupt Engine - Main Technical Engine - Triggered at each frame display, part 3");
    produceAsmScript(file,"code\\common\\tech\\interrupts\\unused_vint_3",0x13C0,0x140E,"Unused Vertical Interrupt engine functions");
    produceAsmScript(file,"code\\common\\tech\\interrupts\\applyvramdmafill",0x140E,0x14A6,"Vertical Interrupt Engine - VRAM DMA filler function");
    ...
    produceAsmScript(file,"code\\common\\tech\\graphics\\graphics_1",0x1770,0x183C,"Graphics functions, part 1");
    produceAsmScript(file,"data\\tech\\spellanimations",0x183C,0x18C2,"Spell animations data");
    produceAsmScript(file,"code\\common\\tech\\graphics\\unused_graphics",0x18C2,0x1942,"Unused graphics functions");
    produceAsmScript(file,"code\\common\\tech\\graphics\\graphics_2",0x1942,0x19C8,"Graphics functions, part 2");
    produceAsmScript(file,"code\\common\\tech\\graphics\\updatefadingpalette",0x19C8,0x1A84,"Palette update during fading function");
    produceAsmScript(file,"code\\common\\tech\\graphics\\decompression",0x1A84,0x20E6,"Graphics decompression and loading functions");
    produceAsmScript(file,"code\\common\\maps\\mapload",0x20E6,0x2EC0,"Map loading functions");
    produceAsmScript(file,"code\\common\\maps\\unused_mapload",0x2EC0,0x2F6A,"Unused map loading functions");
    produceAsmScript(file,"data\\tech\\displaydata",0x2F6A,0x3022,"Display data tables");
    produceAsmScript(file,"code\\common\\tech\\graphics\\displayinit",0x3022,0x30BE,"Display initialization");
    produceAsmScript(file,"code\\common\\tech\\graphics\\unused_display",0x30BE,0x30EE,"Unused display function");
    produceAsmScript(file,"code\\common\\tech\\graphics\\display",0x30EE,0x3758,"Display functions");
    produceAsmScript(file,"code\\gameflow\\exploration\\exploration",0x3758,0x4544,"Exploration functions");
    ...
    produceAsmScript(file,"code\\common\\scripting\\entity\\entityscriptengine_1",0x4C68,0x4E86,"Entity script engine, part 1");
    produceAsmScript(file,"code\\common\\scripting\\entity\\unused_entityscriptfunction",0x4E86,0x4EC6,"Unused entity script function");
    produceAsmScript(file,"code\\common\\scripting\\entity\\entityscriptengine_2",0x4EC6,0x6260,"Entity script engine, part 2");
    produceAsmScript(file,"code\\common\\scripting\\text\\textfunctions",0x6260,0x6D74,"Text functions");
    produceAsmScript(file,"code\\common\\scripting\\text\\unused_textfunctionsdata",0x6D74,0x6E94,"Unused text functions data");
    ...
    produceAsmScript(file,"code\\gameflow\\start\\gameinit",0x70D2,0x7186,"Game initialization");    
    produceAsmScript(file,"data\\maps\\global\\debugmodemaps",0x7186,0x71BF,"Debug mode maps");    
    produceAsmSectionNoPretty(file,"",0x71BF,0x71C0);
    produceAsmScript(file,"code\\gameflow\\start\\gameintro",0x71C0,0x724E,"Game intro");    
    produceAsmScript(file,"code\\specialscreens\\witch\\witchstart",0x724E,0x75C4,"Start witch screen");    
    produceAsmScript(file,"code\\gameflow\\mainloop",0x75C4,0x75EC,"Main loop");    
    produceAsmScript(file,"code\\common\\maps\\egressinit",0x75EC,0x764E,"Egress map initialization function");    
    ...
    produceAsmScript(file,"code\\common\\maps\\mapinit_0",0x7956,0x7988,"Map initialization functions");    
...
static produceSpecificSectionTwo(mainFile,sectionName,start,end,fs,sectionComment){
    ...
    produceAsmScript(file,"code\\common\\stats\\combatantstats_1",0x82D0,0x851A,"Read combatant stats");
    produceAsmScript(file,"code\\common\\stats\\getcombatanttype",0x851A,0x853A,"Combatant type getter function");
    produceAsmScript(file,"data\\stats\\allies\\classes\\classtypes",0x853A,0x855A,"Class types table");
    produceAsmScript(file,"code\\common\\stats\\combatantstats_2",0x855A,0x8970,"Modify combatant stats");
    produceAsmScript(file,"code\\common\\stats\\findname",0x8970,0x898E,"Find an item, spell, or class name");
    produceAsmScript(file,"code\\common\\stats\\gold",0x898E,0x89CE,"Gold management functions");
    produceAsmScript(file,"code\\common\\stats\\updatecombatantstats",0x89CE,0x8BD0,"Functions to apply equip and status effects on stats");
    produceAsmScript(file,"code\\common\\stats\\itemstats",0x8BD0,0x91C6,"Item stats management functions");
    produceAsmScript(file,"code\\common\\stats\\spellstats",0x91C6,0x928E,"Spell stats management functions");
    produceAsmScript(file,"code\\common\\stats\\combatantstats_3",0x928E,0x9482,"Manage combatant stats");
    produceAsmScript(file,"code\\common\\stats\\unusedsub_9482",0x9482,0x9484,"Unused nullsub");
    produceAsmScript(file,"code\\common\\stats\\levelup",0x9484,0x9736,"Level Up functions");
    produceAsmScript(file,"code\\common\\stats\\newgame",0x9736,0x98B4,"New game initialization functions");
    produceAsmScript(file,"code\\common\\stats\\gameflags",0x98B4,0x9900,"Game progression flags management functions");
    produceAsmScript(file,"code\\common\\stats\\battleparty",0x9900,0x99DE,"Join or Leave Force and battle party management functions");
    produceAsmScript(file,"code\\common\\stats\\dealsinventory",0x99DE,0x9A3C,"Deals inventory management functions");
    produceAsmScript(file,"code\\common\\stats\\caravaninventory",0x9A3C,0x9A9A,"Caravan inventory management functions");
    writestr(file,"                \n");
    ...
    produceAsmScript(file,"code\\gameflow\\battle\\battleactions\\battleactionsengine_1",0x9B92,0x9EC4,"Battleactions Engine, part 1");
    ...
    produceAsmScript(file,"code\\gameflow\\battle\\battleactions\\battleactionsengine_2",0xA34E,0xA49C,"Battleactions Engine, part 2");
    ...
    produceAsmScript(file,"code\\gameflow\\battle\\battleactions\\animateaction",0xA6E8,0xA7F8,"Battlescene animation functions");
    produceAsmScript(file,"code\\gameflow\\battle\\battleactions\\giveexpandgold",0xA7F8,0xA870,"Give EXP and gold function");
    produceAsmScript(file,"data\\battles\\global\\halvedexpearnedbattles",0xA870,0xA872,"Halved EXP earned battles table");
    writestr(file,"                align\n");
    produceAsmScript(file,"code\\gameflow\\battle\\battleactions\\earnexp",0xA872,0xA9CC,"EXP earning functions");
    produceAsmScript(file,"code\\gameflow\\battle\\battleactions\\sorttargets",0xA9CC,0xAA98,"Sort targets list function");
    produceAsmScript(file,"code\\gameflow\\battle\\battleactions\\unused_battleactions",0xAA98,0xAAB6,"Unused battleactions functions");
    produceAsmScript(file,"code\\gameflow\\battle\\battleactions\\attack",0xAAB6,0xAAFC,"Write Battlescene Script : Attack");
    ...
    produceAsmScript(file,"code\\gameflow\\battle\\battleactions\\inflictdamage",0xACEA,0xAE32,"Write Battlescene Command : Inflict Damage function");
    produceAsmScript(file,"code\\gameflow\\battle\\battleactions\\inflictailment",0xAE32,0xAF70,"Write Battlescene Command : Inflict Ailment function");
    produceAsmScript(file,"code\\gameflow\\battle\\battleactions\\inflictcursedamage",0xAF70,0xB00E,"Write Battlescene Command : Inflict Curse Damage function");
    produceAsmScript(file,"code\\gameflow\\battle\\battleactions\\determinedoubleandcounter",0xB00E,0xB080,"Write Battlescene Command : Determine Double And Counter function");
    produceAsmScript(file,"code\\gameflow\\battle\\battleactions\\displaydeathmessage",0xB080,0xB0A8,"Write Battlescene Command : Display Death Message function");
    ...
    produceAsmScript(file,"code\\gameflow\\battle\\battlefield\\getenemydestination",0xC024,0xC070,"Battlefield engine");
    produceAsmScript(file,"code\\gameflow\\battle\\battleloop\\clearaimemory",0xC070,0xC09A,"Battle loop function");
    ...
    produceAsmScript(file,"code\\gameflow\\battle\\ai\\startaicontrol",0xDEFC,0xE1AC,"AI engine : preparatory phase");
...
static produceSpecificSectionThree(mainFile,sectionName,start,end,fs,sectionComment){
    ...
    produceAsmScript(file,"code\\common\\menus\\menuenginecommon",0x100C8,0x101F6,"Menu engine, part 1 : Common functions");
    produceAsmScript(file,"code\\common\\menus\\diamondmenu",0x101F6,0x10586,"Diamond menu actions");
    produceAsmScript(file,"code\\common\\menus\\itemmenu",0x10586,0x10940,"Battlefield item menu functions");
    produceAsmScript(file,"code\\common\\menus\\loadhighlightableicon",0x10940,0x1098A,"Load highlightable icon function");
    produceAsmScript(file,"code\\common\\tech\\incbins\\s03_incbins_iconhighlight",0x1098A,0x10A4A,"Game Section 03 Incbin Icon Highlight Tiles");
    produceAsmScript(file,"code\\common\\menus\\magicmenu",0x10A4A,0x10E1C,"Battlefield magic menu actions");
    ...
    produceAsmScript(file,"data\\graphics\\tech\\menus\\spelllevelindiacatorlayouts",0x110A4,0x1115C,"Spell level indicator layouts");
    produceAsmScript(file,"code\\common\\menus\\menutilespointertable",0x1115C,0x11180,"Menu tiles pointer table");
    produceAsmScript(file,"code\\common\\menus\\menustringspointertable",0x11180,0x11306,"Menu strings pointer table");
    produceAsmScript(file,"data\\graphics\\tech\\menus\\diamondmenubordertiles",0x11306,0x113C6,"Diamond menu border uncompressed tiles");
    produceAsmScript(file,"code\\common\\menus\\equipmenu",0x113C6,0x114BE,"Menu engine, part 2 : Battlefield equip menu actions");
    produceAsmScript(file,"data\\graphics\\tech\\windowlayouts\\battleequipwindowlayout",0x114BE,0x11572,"Battlefield equip window layout");
    produceAsmScript(file,"code\\common\\menus\\ministatuswindow",0x11572,0x11AEC,"Menu engine, part 3 : Mini status window functions");
    produceAsmScript(file,"data\\graphics\\tech\\windowlayouts\\ministatuswindowlayout",0x11AEC,0x11B46,"Mini status window layout");
    produceAsmScript(file,"code\\common\\menus\\portraitwindow",0x11B46,0x11C2A,"Portrait window functions");
    produceAsmScript(file,"code\\common\\menus\\memberscreen",0x11C2A,0x12606,"Menu engine, part 4 : Member screen functions");
    produceAsmScript(file,"code\\common\\menus\\unusedsub_12606",0x12606,0x1263A,"Unused function");
    produceAsmScript(file,"code\\common\\menus\\getcombatantportrait",0x1263A,0x1264E,"Combatant portrait index getter function");
    produceAsmScript(file,"data\\graphics\\tech\\windowlayouts\\portraitwindowlayout",0x1264E,0x1278E,"Portrait window layouts (regular and mirrored");
    ...
    produceAsmScript(file,"code\\common\\menus\\minimapscreen",0x1288E,0x12DEC,"Menu engine, part 5 : Minimap screen functions");
    produceAsmScript(file,"code\\common\\menus\\endingkiss",0x12DEC,0x12F12,"Ending kiss sequence function");
    produceAsmScript(file,"code\\common\\menus\\goldwindow",0x12F12,0x12FE6,"Gold window functions");
    produceAsmScript(file,"code\\common\\menus\\memberslistscreen",0x12FE6,0x147FA,"Members list screen functions");
    produceAsmScript(file,"code\\common\\menus\\shopscreen",0x147FA,0x14EFC,"Menu engine, part 6 : Shop screen functions");
    produceAsmSection(file,"",0x14EFC,0x1505C);
    produceAsmScript(file,"data\\graphics\\tech\\windowlayouts\\shopinventorylayout",0x1505C,0x151D6,"Shop inventory window layout");
    produceAsmSection(file,"",0x151D6,0x15268);
    produceAsmScript(file,"code\\common\\menus\\unusedsub_15268",0x15268,0x15284,"Unused menu engine function");
    produceAsmScript(file,"code\\common\\menus\\yesnoprompt",0x15284,0x154A2,"Yes/No prompt functions");
    produceAsmScript(file,"data\\graphics\\tech\\windowlayouts\\yesnopromptlayout",0x154A2,0x154F6,"Yes/No prompt window layout");
    produceAsmScript(file,"code\\common\\menus\\portraitfunctions",0x154F6,0x156A8,"Portrait functions");
    ...
    produceAsmScript(file,"code\\common\\menus\\landeffectwindow",0x15772,0x1586E,"Menu engine, part 7 : Land effect window functions");
    produceAsmScript(file,"code\\common\\menus\\battlefieldsettingswindow",0x1586E,0x15A5A,"Battlefield settings window functions");
    ...
    produceAsmScript(file,"code\\common\\menus\\nameallyscreen",0x15BB0,0x1607C,"Menu engine, part 8 : Name ally screen functions");
    ...
    produceAsmScript(file,"code\\common\\menus\\numberprompt",0x16282,0x163BC,"Menu engine, part 9 : Number prompt functions");
    produceAsmScript(file,"code\\common\\menus\\debugsetflag",0x163BC,0x1650C,"Debug : Set flag prompt");
    produceAsmScript(file,"code\\common\\menus\\timerwindow",0x1650C,0x16618,"Timer window functions");
    ...
    produceAsmScript(file,"code\\common\\menus\\nameunderportraitwindow",0x169AE,0x16A62,"Menu engine, part 10 : Name under portrait window functions");
...
static produceSpecificSectionFour(mainFile,sectionName,start,end,fs,sectionComment){
    ...
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\nullsub_18010",0x18010,0x18012,"Battlescene engine");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\initializebattlescene",0x18012,0x18398,"Battlescene engine");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\battlesceneengine_0",0x18398,0x197C8,"Battlescene engine");
    ...
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\battlesceneengine_2",0x19E6E,0x1A028,"Battlescene engine");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\tintscreen",0x1A028,0x1A2A6,"Battlescene engine");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\battlesceneengine_3",0x1A2A6,0x1A478,"Battlescene engine");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\nothing",0x1A478,0x1A47A,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\blaze",0x1A47A,0x1A654,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\freeze",0x1A654,0x1A73A,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\desoul",0x1A73A,0x1A848,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\healingfairy",0x1A848,0x1A928,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\blast",0x1A928,0x1AA40,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\detox",0x1AA40,0x1AA90,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\bolt",0x1AA90,0x1AB9E,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\buff",0x1AB9E,0x1ABF4,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\debuff",0x1ABF4,0x1ACD8,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\absorb",0x1ACD8,0x1ACE4,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\demonbreath",0x1ACE4,0x1AD3E,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\flamebreath",0x1AD3E,0x1ADA4,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\arrowsandspears",0x1ADA4,0x1AEB0,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\cannonfire",0x1AEB0,0x1AF0A,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\shotfire",0x1AF0A,0x1AF8C,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\gunnerblast",0x1AF8C,0x1B012,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\dao",0x1B012,0x1B0D0,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\apollo",0x1B0D0,0x1B21A,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\neptun",0x1B21A,0x1B37C,"");
    ...
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\burstrock",0x1B6EA,0x1B716,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\oddeyebeam",0x1B716,0x1B7B0,"");
    
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\updatespellanimation",0x1B7B0,0x1B93C,"Battlescene engine");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\update\\blaze",0x1B93C,0x1BE9E,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\update\\freeze",0x1BE9E,0x1C248,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\update\\desoul",0x1C248,0x1C53E,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\update\\healingfairy",0x1C53E,0x1C7F6,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\update\\blast",0x1C7F6,0x1CC56,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\update\\detox",0x1CC56,0x1CE50,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\update\\bolt",0x1CE50,0x1CFFC,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\update\\buff",0x1CFFC,0x1D038,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\update\\debuff",0x1D038,0x1D0FE,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\update\\demonbreath",0x1D0FE,0x1D2E6,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\update\\flamebreath",0x1D2E6,0x1D4E6,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\update\\arrowsandspears",0x1D4E6,0x1D5C6,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\update\\cannonfire",0x1D5C6,0x1D786,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\update\\shotfire",0x1D786,0x1D9FC,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\update\\gunnerblast",0x1D9FC,0x1DCE8,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\update\\dao",0x1DCE8,0x1DE24,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\update\\apollo",0x1DE24,0x1DFD4,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\update\\neptun",0x1DFD4,0x1E134,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\update\\atlas",0x1E134,0x1E2D4,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\update\\prismlaser",0x1E2D4,0x1E5D0,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\update\\bubblebreath",0x1E5D0,0x1E7B2,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\update\\snowbreath",0x1E7B2,0x1E958,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\update\\attackspell",0x1E958,0x1EA0C,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\update\\phoenixattack",0x1EA0C,0x1EBBA,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\update\\burstrock",0x1EBBA,0x1ECC8,"");
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\animation\\update\\oddeyebeam",0x1ECC8,0x1EE2C,"");
    
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\battlesceneengine_4",0x1EE2C,0x1F806,"Battlescene engine");
...
static produceSpecificSectionFive(mainFile,sectionName,start,end,fs,sectionComment){
    ...
    produceAsmScript(file,"code\\common\\menus\\caravan\\caravanactions_1",0x21FD2,0x228A2,"Caravan menu functions");
    produceAsmScript(file,"data\\stats\\items\\specialcaravandescriptions",0x228A2,0x228A8,"Special Caravan descriptions");
    produceAsmScript(file,"code\\common\\menus\\caravan\\caravanactions_2",0x228A8,0x229CA,"Caravan menu functions");
    produceAsmScript(file,"code\\common\\menus\\item\\isitemusableonfield",0x229CA,0x229E2,"Item menu function");
    produceAsmScript(file,"data\\stats\\items\\usableoutsidebattleitems",0x229E2,0x229EC,"Usable outside battle items");
    produceAsmScript(file,"code\\common\\menus\\item\\fielditemeffects",0x229EC,0x22C60,"Functions to perform effects from using items on the exploration field");
    produceAsmScript(file,"code\\common\\menus\\getplayerentityposition",0x22C60,0x22C84,"Main menu function");
    writestr(file,"                \n");
    writestr(file,"                ; Battle functions\n");
    produceAsmScript(file,"code\\gameflow\\battle\\battlefunctions\\battlefunctions_0",0x22C84,0x2379A,"Battle functions");
    ...
    produceAsmScript(file,"code\\gameflow\\battle\\battlefunctions\\battleloop_1",0x23A84,0x23BB4,"Battle loop main, part 1");
    produceAsmScript(file,"code\\gameflow\\battle\\battleloop\\killallenemies",0x23BB4,0x23BFC,"Battle loop function");
    produceAsmScript(file,"code\\gameflow\\battle\\battleloop\\heallivingandimmortalallies",0x23BFC,0x23C58,"Battle loop function");
    produceAsmScript(file,"code\\gameflow\\battle\\battleloop\\countremainingcombatants",0x23C58,0x23CBA,"Battle loop function");
    produceAsmScript(file,"code\\gameflow\\battle\\battlefunctions\\battleloop_2",0x23CBA,0x23D98,"Battle loop main, part 2");
    produceAsmScript(file,"code\\gameflow\\battle\\battlefunctions\\battlefunctions_1",0x23D98,0x23E50,"Battle functions");
    produceAsmScript(file,"code\\gameflow\\battle\\battleloop\\getegresspositionforbattle",0x23E50,0x23EB0,"Battle loop : Get Egress Position For Battle function");
    ...
    produceAsmScript(file,"code\\gameflow\\battle\\battleloop\\processafterturneffects",0x24242,0x2448A,"Battle loop functions");
    produceAsmScript(file,"code\\gameflow\\battle\\battleloop\\spawnenemy",0x2448A,0x24512,"Battle loop functions");
    produceAsmScript(file,"code\\gameflow\\battle\\battleloop\\cleardeadcombatantslist",0x24512,0x24518,"Battle loop functions");
    produceAsmScript(file,"code\\gameflow\\battle\\battleloop\\processkilledcombatants",0x24518,0x24642,"Battle loop functions");
    produceAsmScript(file,"code\\gameflow\\battle\\battlefunctions\\battlefunctions_2",0x24642,0x2550C,"Battle functions");
    produceAsmScript(file,"code\\gameflow\\battle\\battleloop\\updateenemyai",0x2550C,0x25544,"Battle loop : Enemy AI update functions");
    produceAsmScript(file,"code\\gameflow\\battle\\battleloop\\turnorderfunctions",0x25544,0x25610,"Battle loop : Turn order functions");
    produceAsmScript(file,"code\\gameflow\\battle\\battlefunctions\\loadBattle",0x25610,0x256A2,"Battle data loading function");
    produceAsmScript(file,"code\\gameflow\\battle\\battlefunctions\\battlefunctions_3",0x256A2,0x2572A,"Battle functions");
    produceAsmScript(file,"code\\gameflow\\battle\\battleloop\\printdefcons",0x2572A,0x25790,"Battle loop : Debug messages");
...
static produceSpecificSectionSix(mainFile,sectionName,start,end,fs,sectionComment){
    ...
    produceAsmSection(file,"",0x29001,0x29002);
    produceAsmScript(file,"code\\common\\tech\\incbins\\s06_incbins_graphics",0x29002,0x2C576,"Game Section 06 Incbin Directives, part 1");
    ...
    produceAsmScript(file,"code\\common\\tech\\incbins\\s06_incbins_titlescreen",0x2C7A0,0x2E10E,"Game Section 06 Incbin Directives, part 2");
    produceAsmScript(file,"code\\common\\scripting\\text\\decoding",0x2E10E,0x2E196,"Text decoding functions");    
    produceAsmScript(file,"code\\common\\tech\\incbins\\s06_incbins_textbanktrees",0x2E196,0x2EB34,"Game Section 06 Incbin Directives, part 3");
    produceAsmScript(file,"data\\scripting\\text\\entries",0x2EB34,0x4201E,"Textbank entries");   
    produceAsmScript(file,"data\\scripting\\gamestaff",0x4201E,0x425E7,"Game Staff");
    produceAsmSection(file,"",0x425E7,0x44000);
...
static produceSpecificSectionSeven(mainFile,sectionName,start,end,fs,sectionComment){
    ...
    produceAsmScript(file,"code\\gameflow\\battle\\cutscenes\\beforebattlecutscenesstart",0x47A50,0x47A88,"Before battle cutscenes function start");
    produceAsmScript(file,"data\\battles\\cutscenes\\beforebattlecutscenes",0x47A88,0x47AE8,"Before battle cutscenes");
    produceAsmScript(file,"code\\gameflow\\battle\\cutscenes\\beforebattlecutscenesend",0x47AE8,0x47AEE,"Before battle cutscenes function end");
    produceAsmScript(file,"code\\gameflow\\battle\\cutscenes\\battlestartcutscenesstart",0x47AEE,0x47B2C,"Battle start cutscenes function start");
    produceAsmScript(file,"data\\battles\\cutscenes\\battlestartcutscenes",0x47B2C,0x47B8C,"Battle start cutscenes");
    produceAsmScript(file,"code\\gameflow\\battle\\cutscenes\\battlestartcutscenesend",0x47B8C,0x47B92,"Battle start cutscenes function end");
    produceAsmScript(file,"code\\gameflow\\battle\\cutscenes\\battleendcutscenesstart",0x47B92,0x47BE8,"Battle end cutscenes function start");
    produceAsmScript(file,"data\\battles\\cutscenes\\battleendcutscenes",0x47BE8,0x47C48,"Enemy defeated cutscenes");
    produceAsmScript(file,"code\\gameflow\\battle\\cutscenes\\battleendcutscenesend",0x47C48,0x47C8E,"Battle end cutscenes function end");
    ...
    produceAsmScript(file,"code\\gameflow\\battle\\cutscenes\\afterbattlecutscenesstart",0x47CBC,0x47CF4,"After battle cutscenes function start");
    produceAsmScript(file,"data\\battles\\cutscenes\\afterbattlecutscenes",0x47CF4,0x47D54,"After battle cutscenes");
    produceAsmScript(file,"code\\gameflow\\battle\\cutscenes\\afterbattlecutscenesend",0x47D54,0x47D6A,"After battle cutscenes function end");
    produceAsmScript(file,"data\\battles\\cutscenes\\afterbattlejoins",0x47D6A,0x47D9E,"After battle joins (unused)");
    produceAsmScript(file,"code\\gameflow\\battle\\cutscenes\\afterenemyleaderdeathpositions",0x47D9E,0x47E6C,"After-battlescene listener used to prepare entity positions for end cutscene before the enemy leader dies. Only used in battle 5.");
    produceAsmScript(file,"data\\battles\\afterbattlepositions",0x47E6C,0x47E82,"After battle positions");
    produceAsmScript(file,"code\\gameflow\\battle\\cutscenes\\regionactivatedcutscenes",0x47E82,0x47EC8,"Region-activated cutscenes functions");
    produceAsmScript(file,"data\\battles\\cutscenes\\regionactivatedcutscenes",0x47EC8,0x47EEA,"Region-activated cutscenes data");
    ...
    produceAsmScript(file,"code\\common\\stats\\iteminventory",0x4F48A,0x4F6E2,"Item inventory management functions");
...
static produceSpecificSectionTen(mainFile,sectionName,start,end,fs,sectionComment){
    ...
    produceAsmScript(file,"code\\specialscreens\\title\\graphics",0x1002BE,0x1014E0,"Title Screen Graphics");
    produceAsmScript(file,"data\\graphics\\specialscreens\\titlescreen\\titlescreenlayouts",0x1014E0,0x101EE0,"Title Screen Layouts");
...
static produceSpecificSectionEleven(mainFile,sectionName,start,end,fs,sectionComment){
    ...
    produceAsmScript(file,"data\\graphics\\battles\\battlesprites\\enemies\\entries",0x130004,0x17FE50,"Enemy battlesprites");  
    produceAsmSection(file,"",0x17FE50,0x180000);
...
static produceSpecificSectionThirteen(mainFile,sectionName,start,end,fs,sectionComment){
    ...
    produceAsmScript(file,"code\\common\\scripting\\endcredits",0x1AC068,0x1AC38E,"Ending credits functions");
    produceAsmScript(file,"code\\gameflow\\battle\\battle_s13_1",0x1AC38E,0x1AC9B8,"Battle initialization, terrain, AI stuff to split more properly");            
    produceAsmScript(file,"data\\battles\\global\\laserbattles",0x1AC9B8,0x1AC9FC,"Laser battles data");
    produceAsmScript(file,"code\\gameflow\\battle\\battleloop\\triggerregions",0x1AC9FC,0x1ACF30,"AI regions trigger update functions");
    produceAsmScript(file,"code\\gameflow\\battle\\battleloop\\populateenemyspawns",0x1ACF30,0x1AD090,"Enemy respawn functions");
    produceAsmScript(file,"code\\common\\tech\\thinkingairng",0x1AD090,0x1AD0DC,"Thinking AI RNG");
    produceAsmScript(file,"code\\gameflow\\battle\\battleloop\\loadbattleterraindata",0x1AD0DC,0x1AD104,"Load battle terrain data function");
    produceAsmScript(file,"data\\battles\\terrainentries",0x1AD104,0x1B120A,"Battle terrain data");    
    produceAsmScript(file,"code\\gameflow\\battle\\battledebugfunction1B120A",0x1B120A,0x1B1272,"unused");
    produceAsmScript(file,"code\\gameflow\\battle\\battleloop\\initializecombatants",0x1B1272,0x1B15F8,"Battle loop functions");     
    produceAsmScript(file,"code\\gameflow\\battle\\battle_s13_3",0x1B15F8,0x1B1780,"Battle initialization, terrain, AI stuff to split more properly");
    produceAsmScript(file,"code\\gameflow\\battle\\battleloop\\upgradeenemies",0x1B1780,0x1B1A28,"Upgrade random battle enemies to stronger ones");
    produceAsmScript(file,"code\\gameflow\\battle\\battleloop\\hasjarojoined",0x1B1A28,0x1B1A66,"Battle loop function");   
    ...
    produceAsmScript(file,"data\\battles\\global\\randombattles",0x1B6DB0,0x1B6DDA,"Random battles list, and data related to enemy upgrade functions");
...
static produceSpecificSectionSeventeen(mainFile,sectionName,start,end,fs,sectionComment){
    ...
    produceAsmScript(file,"code\\common\\tech\\incbins\\s17_incbins_basetiles",0x1EF5A6,0x1EFE32,"Game Section 17 Incbin Directives");
    produceAsmSection(file,"",0x1EFE32,0x1F0000);
