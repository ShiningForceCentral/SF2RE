...
static produceSpecificSectionTwo(mainFile,sectionName,start,end,fs,sectionComment){
    ...
    produceAsmScript(file,"code\\gameflow\\battle\\initbattlesceneproperties",0x9F28,0xA05C,"Init Battlescene Properties function");
    produceAsmScript(file,"code\\gameflow\\battle\\createbattlescenemessage",0xA05C,0xA200,"Create Battlescene Message function");
    ...
    produceAsmScript(file,"code\\gameflow\\battle\\battleactionsengine_2",0xA34E,0xA49C,"Battle actions engine");
    produceAsmScript(file,"code\\gameflow\\battle\\isabletocounterattack",0xA49C,0xA54E,"Is Able To Counter Attack function");
    produceAsmScript(file,"code\\gameflow\\battle\\getspellanimation",0xA54E,0xA6E8,"Get spell animation function");
    produceAsmScript(file,"code\\gameflow\\battle\\battleactionsengine_3",0xA6E8,0xA870,"Battle actions engine");
    produceAsmScript(file,"data\\battles\\global\\halvedexpearnedbattles",0xA870,0xA872,"Halved EXP earned battles table");
    writestr(file,"                align\n");
    produceAsmScript(file,"code\\gameflow\\battle\\battleactionsengine_4",0xA872,0xACCA,"Battle actions engine");
    produceAsmScript(file,"data\\stats\\allies\\classes\\criticalhitsettings",0xACCA,0xACEA,"Critical hit settings");
    produceAsmScript(file,"code\\gameflow\\battle\\battleactionsengine_5",0xACEA,0xBCF0,"Battle actions engine");
    ...
    produceAsmScript(file,"code\\gameflow\\battle\\battleactionsengine_6",0xC024,0xC09A,"Battle actions engine");
    ...
    writestr(file,"                align\n");
    produceAsmScript(file,"code\\gameflow\\battle\\battlefieldengine_2",0xC27A,0xC306,"Battlefield engine");
    produceAsmScript(file,"code\\gameflow\\battle\\getattackrange",0xC306,0xC380,"Get Attack Range function");
    produceAsmScript(file,"code\\gameflow\\battle\\battlefieldengine_3",0xC380,0xCD68,"Battlefield engine");
    ...
    produceAsmScript(file,"code\\gameflow\\battle\\battlefieldengine_4",0xCDEA,0xCF74,"Battlefield engine");
    produceAsmScript(file,"code\\gameflow\\battle\\useableaiactions",0xCF74,0xD1CC,"Usable AI actions getter functions");
    produceAsmScript(file,"code\\gameflow\\battle\\battlefieldengine_5",0xD1CC,0xD38A,"Battlefield engine");
    ...
    produceAsmScript(file,"code\\gameflow\\battle\\battlefieldengine_6",0xD3CA,0xD824,"Battlefield engine");
    ...
    produceAsmScript(file,"code\\gameflow\\battle\\battlefieldengine_7",0xD8F4,0xDEFC,"Battlefield engine");
    ...
    produceAsmScript(file,"code\\gameflow\\battle\\handleaicommand",0xE294,0xE3EE,"Handle AI Command function");
    produceAsmScript(file,"code\\gameflow\\battle\\aicommandheal",0xE3EE,0xE78C,"AI command : Heal");
    
    produceAsmScript(file,"code\\gameflow\\battle\\aicommandattack",0xE78C,0xE98C,"AI command : Attack");
    produceAsmScript(file,"code\\gameflow\\battle\\aicommandspecialmove",0xE98C,0xEBA4,"AI command : Special Move");
    produceAsmScript(file,"code\\gameflow\\battle\\aicommandsupport",0xEBA4,0xEDD6,"AI command : Support");
    produceAsmScript(file,"code\\gameflow\\battle\\determineaibattleaction",0xEDD6,0xF1D4,"Determine AI Battleaction function");
    produceAsmScript(file,"code\\gameflow\\battle\\aicommandmove.asm",0xF1D4,0xF522,"AI command : Move");
    produceAsmScript(file,"code\\gameflow\\battle\\aiengine_2",0xF522,0xF9B4,"AI engine");
...
static produceSpecificSectionThree(mainFile,sectionName,start,end,fs,sectionComment){
    ...
    produceAsmScript(file,"code\\common\\menus\\menuengine_01",0x10000,0x10E1C,"Menu engine");
    ...
    produceAsmSection(file,"",0x1623A,0x16282);
...
static produceSpecificSectionFour(mainFile,sectionName,start,end,fs,sectionComment){
    ...
    produceAsmScript(file,"code\\gameflow\\battle\\battlescenes\\battlesceneengine_0",0x18000,0x197C8,"Battlescene engine");
...
static produceSpecificSectionFive(mainFile,sectionName,start,end,fs,sectionComment){
    ...
    produceAsmScript(file,"code\\gameflow\\battle\\battlefunctions_1",0x23A84,0x23E50,"Battle functions");
    produceAsmScript(file,"code\\gameflow\\battle\\getegresspositionforbattle",0x23E50,0x23EB0,"Get Egress Position For Battle function");
    produceAsmScript(file,"code\\gameflow\\battle\\executeindividualturn",0x23EB0,0x24242,"Execute Individual Turn function");
    produceAsmScript(file,"code\\gameflow\\battle\\handleafterturneffects",0x24242,0x2448A,"Handle After Turn Effects function");
    produceAsmScript(file,"code\\gameflow\\battle\\battlefunctions_2",0x2448A,0x2550C,"Battle functions");
    produceAsmScript(file,"code\\gameflow\\battle\\updateenemyaifunctions",0x2550C,0x25544,"Update Enemy AI functions");
    produceAsmScript(file,"code\\gameflow\\battle\\battleturnorderfunctions",0x25544,0x25610,"Battle turn order functions");
    produceAsmScript(file,"code\\gameflow\\battle\\battlefunctions_3",0x25610,0x257C0,"Battle functions");
