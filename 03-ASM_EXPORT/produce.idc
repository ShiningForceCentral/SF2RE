...
static produceSpecificSectionThree(mainFile,sectionName,start,end,fs,sectionComment){
    ...
    produceAsmScript(file,"code\\common\\menus\\menuengine_06",0x1288E,0x135A6,"Menu engine");
    produceAsmScript(file,"code\\common\\menus\\writememberlisttext",0x135A6,0x137AC,"Write member list text function");
    produceAsmScript(file,"code\\common\\menus\\menuengine_07",0x137AC,0x15736,"Menu engine");
    produceAsmScript(file,"code\\common\\menus\\getallyportrait",0x15736,0x15772,"Get ally portrait index function");
    produceAsmScript(file,"code\\common\\menus\\menuengine_08",0x15772,0x15A5A,"Menu engine");
    ...
    produceAsmScript(file,"code\\common\\menus\\menuengine_09",0x15BB0,0x1607C,"Menu engine");
    ...
    produceAsmScript(file,"code\\common\\menus\\menuengine_10",0x1623A,0x16618,"Menu engine");
    produceAsmScript(file,"data\\graphics\\tech\\windowlayouts\\timerwindowlayout",0x16618,0x16658,"Timer window layout");
    produceAsmScript(file,"code\\common\\menus\\menuengine_11",0x16658,0x16A62,"Menu engine");
