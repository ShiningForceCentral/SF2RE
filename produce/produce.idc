...
static produceSpecificSectionSeven(mainFile,sectionName,start,end,fs,sectionComment){
	...
	produceAsmScript(file,"battles\\battleneutralentities",0x448C4,0x4497A,"Battle entities which are not force members or enemies");
	produceAsmScript(file,"battles\\eas_battleneutralentities",0x4497A,0x449C6,"Entity actscripts for battle entities which are not force members or enemies");
	...
	produceAsmScript(file,"battles\\cs_beforebattle",0x47A88,0x47AE8,"Before battle cutscenes");
	produceAsmSection(file,0x47AE8,0x47B2C);
	produceAsmScript(file,"battles\\cs_battlestart",0x47B2C,0x47B8C,"Battle start cutscenes");
	produceAsmSection(file,0x47B8C,0x47BE8);
	produceAsmScript(file,"battles\\cs_enemydefeated",0x47BE8,0x47C48,"Enemy defeated cutscenes");
	produceAsmSection(file,0x47C48,0x47CF4);
	produceAsmScript(file,"battles\\cs_afterbattle",0x47CF4,0x47D54,"After battle cutscenes");
	produceAsmSection(file,0x47D54,0x47EC8);	
	produceAsmScript(file,"battles\\cs_regionactivated",0x47EC8,0x47EEA,"Region-activated cutscenes");
	...
	produceAsmScript(file,"battles\\entries\\battle01\\bbcs",0x494BC,0x496DC,"Cutscene before battle 1");
	produceAsmScript(file,"battles\\entries\\battle01\\abcs",0x496DC,0x4980E,"Cutscene after battle 1");
	produceAsmScript(file,"battles\\entries\\battle03\\bbcs",0x4980E,0x4981E,"Cutscene before battle 3");
	produceAsmScript(file,"battles\\entries\\battle04\\bbcs",0x4981E,0x498EE,"Cutscene before battle 4");
	produceAsmScript(file,"battles\\entries\\battle04\\abcs",0x498EE,0x49AB2,"Cutscene after battle 4");
	produceAsmScript(file,"battles\\entries\\battle05\\edcs",0x49AB2,0x49B48,"Enemy defeated cutscene for battle 5");
	produceAsmScript(file,"battles\\entries\\battle05\\abcs",0x49B48,0x49BCA,"Cutscene after battle 5");
	produceAsmScript(file,"battles\\entries\\battle06\\bbcs",0x49BCA,0x49CE2,"Cutscene before battle 6");
	produceAsmScript(file,"battles\\entries\\battle07\\bbcs",0x49CE2,0x49F7E,"Cutscene before battle 7");
	produceAsmScript(file,"battles\\entries\\battle07\\abcs",0x49F7E,0x4A952,"Cutscene after battle 7");
	produceAsmScript(file,"battles\\entries\\battle08\\bbcs",0x4A952,0x4AA74,"Cutscene before battle 8");
	produceAsmScript(file,"battles\\entries\\battle08\\abcs",0x4AA74,0x4ABFE,"Cutscene after battle 8");
	produceAsmScript(file,"battles\\entries\\battle11\\bbcs",0x4ABFE,0x4ACC8,"Cutscene before battle 11");
	produceAsmScript(file,"battles\\entries\\battle12\\edcs",0x4ACC8,0x4ACEC,"Enemy defeated cutscene for battle 12");
	produceAsmScript(file,"battles\\entries\\battle12\\abcs",0x4ACEC,0x4ACF8,"Cutscene after battle 12");
	produceAsmScript(file,"battles\\entries\\battle13\\abcs",0x4ACF8,0x4ADA6,"Cutscene after battle 13");
	produceAsmScript(file,"battles\\entries\\battle15\\bbcs",0x4ADA6,0x4AE72,"Cutscene before battle 15");
	produceAsmScript(file,"battles\\entries\\battle15\\abcs",0x4AE72,0x4AFBE,"Cutscene after battle 15");
	produceAsmScript(file,"battles\\entries\\battle16\\bbcs",0x4AFBE,0x4B1BC,"Cutscene before battle 16");
	produceAsmScript(file,"battles\\entries\\battle16\\abcs",0x4B1BC,0x4B1D8,"Cutscene after battle 16");
	produceAsmScript(file,"battles\\entries\\battle18\\bbcs",0x4B1D8,0x4B2F2,"Cutscene before battle 18");
	produceAsmScript(file,"battles\\entries\\battle18\\abcs",0x4B2F2,0x4B6CE,"Cutscene after battle 18");
	produceAsmScript(file,"battles\\entries\\battle20\\abcs",0x4B6CE,0x4B790,"Cutscene after battle 20");
	produceAsmScript(file,"battles\\entries\\battle21\\bbcs",0x4B790,0x4B88C,"Cutscene before battle 21");
	produceAsmScript(file,"battles\\entries\\battle21\\abcs",0x4B88C,0x4B958,"Cutscene after battle 21");
	produceAsmScript(file,"battles\\entries\\battle26\\bbcs",0x4B958,0x4BCAA,"Cutscene before battle 26");
	produceAsmScript(file,"battles\\entries\\battle26\\abcs",0x4BCAA,0x4BE6A,"Cutscene after battle 26");
	produceAsmScript(file,"battles\\entries\\battle27\\bscs",0x4BE6A,0x4BE8C,"Start cutscene for battle 27");
	produceAsmScript(file,"battles\\entries\\battle28\\bbcs",0x4BE8C,0x4C07C,"Cutscene before battle 28");
	produceAsmScript(file,"battles\\entries\\battle28\\abcs",0x4C07C,0x4C3DC,"Cutscene after battle 28");
	produceAsmScript(file,"battles\\entries\\battle29\\bbcs",0x4C3DC,0x4C5E6,"Cutscene before battle 29");
	produceAsmScript(file,"battles\\entries\\battle30\\bbcs",0x4C5E6,0x4C6A8,"Cutscene before battle 30");
	produceAsmScript(file,"battles\\entries\\battle30\\abcs",0x4C6A8,0x4C994,"Cutscene after battle 30");
	produceAsmScript(file,"battles\\entries\\battle31\\bbcs",0x4C994,0x4CBE2,"Cutscene before battle 31");
	produceAsmScript(file,"battles\\entries\\battle32\\bbcs",0x4CBE2,0x4CD10,"Cutscene before battle 32");
	produceAsmScript(file,"battles\\entries\\battle32\\rbcs_1",0x4CD10,0x4CDB4,"Region-activated cutscene for battle 32");
	produceAsmScript(file,"battles\\entries\\battle32\\abcs",0x4CDB4,0x4CF0C,"Cutscene after battle 32");
	produceAsmScript(file,"battles\\entries\\battle33\\bbcs",0x4CF0C,0x4D09A,"Cutscene before battle 33");
	produceAsmScript(file,"battles\\entries\\battle33\\abcs",0x4D09A,0x4D342,"Cutscene after battle 33");
	produceAsmScript(file,"battles\\entries\\battle34\\bbcs",0x4D342,0x4D4B6,"Cutscene before battle 34");
	produceAsmScript(file,"battles\\entries\\battle34\\abcs",0x4D4B6,0x4D6CE,"Cutscene after battle 34");
	produceAsmScript(file,"battles\\entries\\battle35\\bbcs",0x4D6CE,0x4D88A,"Cutscene before battle 35");
	produceAsmScript(file,"battles\\entries\\battle36\\bbcs",0x4D88A,0x4D9A4,"Cutscene before battle 36");
	produceAsmScript(file,"battles\\entries\\battle36\\abcs",0x4D9A4,0x4DA66,"Cutscene after battle 36");
	produceAsmScript(file,"battles\\entries\\battle37\\bbcs",0x4DA66,0x4DB94,"Cutscene before battle 37");
	produceAsmScript(file,"battles\\entries\\battle37\\abcs",0x4DB94,0x4DDA4,"Cutscene after battle 37");
	produceAsmScript(file,"battles\\entries\\battle38\\bbcs",0x4DDA4,0x4DE8C,"Cutscene before battle 38");
	produceAsmScript(file,"battles\\entries\\battle38\\abcs",0x4DE8C,0x4E3D2,"Cutscene after battle 38");
	produceAsmScript(file,"battles\\entries\\battle39\\bbcs",0x4E3D2,0x4E4DC,"Cutscene before battle 39");
	produceAsmScript(file,"battles\\entries\\battle40\\bbcs",0x4E4DC,0x4E8A8,"Cutscene before battle 40");
	produceAsmScript(file,"battles\\entries\\battle40\\rbcs_1",0x4E8A8,0x4E9B2,"Region-activated cutscene 1 for battle 40");
	produceAsmScript(file,"battles\\entries\\battle40\\rbcs_2",0x4E9B2,0x4EA94,"Region-activated cutscene 2 for battle 40");
	produceAsmScript(file,"battles\\entries\\battle40\\abcs",0x4EA94,0x4ED0E,"Cutscene after battle 40");
	produceAsmScript(file,"battles\\entries\\battle41\\bbcs",0x4ED0E,0x4ED8E,"Cutscene before battle 41");
	produceAsmScript(file,"battles\\entries\\battle42\\bbcs",0x4ED8E,0x4EF04,"Cutscene before battle 42");
	produceAsmScript(file,"battles\\entries\\battle42\\abcs",0x4EF04,0x4F358,"Cutscene after battle 42");
	produceAsmScript(file,"battles\\entries\\battle43\\edcs",0x4F358,0x4F35E,"Enemy defeated cutscene for battle 43");
	produceAsmScript(file,"battles\\entries\\battle43\\abcs",0x4F35E,0x4F47A,"Cutscene after battle 43");
	produceAsmScript(file,"battles\\entries\\battle00\\abcs",0x4F47A,0x4F48A,"Cutscene after battle 0");
	
	produceAsmSection(file,0x4F48A,0x4F6E2);
	
	produceAsmScript(file,"maps\\mapsetupstable",0x4F6E2,0x4FA70,"Map setups table");
